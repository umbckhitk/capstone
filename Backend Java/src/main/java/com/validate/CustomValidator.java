...
ValidationUtils.rejectIfEmptyOrWhitespace(error,"dob","error.dob","Date of birth cannot be blank");
...
{
error.rejectValue("password","error.password","Password should be in proper format ");
